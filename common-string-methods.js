...
let startsWithWelcome = inputString.trim().startsWith("Weclome"); // my fisrt attempt did not include trim, but I noticed the effect on line 75
let endsWithToday = inputString.trim().endsWith("today."); // my first attempt did not include trim and it evaluated to false
...
let replacedString = inputString.replace(); // Your code here
...
let extractedBootcamp = inputString.trim().slice(22,23); // Your code here
